...
class QuizQuestionsHuntingMethods : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvHeader.setText(R.string.huntingMethods)
    ...
    private fun saveData() {
        val sharedPreferences = getSharedPreferences(Constants.SHARED_PREFERENCES_HUNTING, MODE_PRIVATE)
...
//        }
        ...
        object: CountDownTimer(mTimeLeftInMillis, 500) {
            ...
            override fun onFinish() {
                if (mInterstitialAd != null) {
                    mInterstitialAd?.show(this@QuizQuestionsHuntingMethods)
                } else {
                    val intent = Intent(this@QuizQuestionsHuntingMethods, FinishQuiz::class.java)
    ...
    @SuppressLint("SetTextI18n")
    private fun setQuestionHuntingMethods(){
...
//        }
    ...
    private fun createInterstitialAdd(adRequest: AdRequest) {
        InterstitialAd.load(this,"ca-app-pub-7588987461083278/1135584471", adRequest, object : InterstitialAdLoadCallback() {
